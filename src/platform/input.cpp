...
static bool input_event_matches_window(const SDL_Event *event)
{
  ...
  case SDL_EVENT_KEY_UP: return event->key.windowID == g_window_id;
  case SDL_EVENT_MOUSE_MOTION: return event->motion.windowID == g_window_id;
  case SDL_EVENT_MOUSE_BUTTON_DOWN:
  case SDL_EVENT_MOUSE_BUTTON_UP: return event->button.windowID == g_window_id;
  case SDL_EVENT_MOUSE_WHEEL: return event->wheel.windowID == g_window_id;
  default: return true;
  }
}
