...
VkResult vk_buffer_create(VkDeviceContext *device, VkDeviceSize size,
...
VkResult vk_buffer_copy(VkDeviceContext *device, VkCommandPool pool,
                        VkBufferContext *src, VkBufferContext *dst, VkDeviceSize size) {
...
VkResult vk_buffer_create_vertex(VkDeviceContext *device, VkCommandPool pool,
                                 const void *data, VkDeviceSize size, VkBufferContext *ctx) {
    LOG_DEBUG("Creating vertex buffer (%llu bytes)", (unsigned long long)size);

    // Create staging buffer
    VkBufferContext staging;
    VkResult result = vk_buffer_create(device, size,
    ...
    result = vk_buffer_create(device, size,
...
VkResult vk_buffer_create_index(VkDeviceContext *device, VkCommandPool pool,
                                const void *data, VkDeviceSize size, VkBufferContext *ctx) {
